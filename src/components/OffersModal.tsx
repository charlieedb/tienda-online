    ...
    <AnimatePresence>
      {open ? (
        <>
          ...
          <motion.aside
            className="fixed left-1/2 top-1/2 z-[60] h-[min(74vh,760px)] w-[min(640px,calc(100vw-3rem))] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-3xl border border-border app-modal-surface shadow-2xl"
